...
/* package Rewriter-0.1.0.0 */
#define VERSION_Rewriter "0.1.0.0"
#define MIN_VERSION_Rewriter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Rewriter-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Rewriter-0.1.0.0"
